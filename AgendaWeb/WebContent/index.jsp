				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<ul class="nav">
							...
							<li class="nav-item"><a href="cadastrar_contato.jsp">Cadastrar
									Contato</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<strong><img src="imagens/users48.png" height="24px"
							width="24px" style="margin-right: 10px;">Meus Contatos</strong>
					</div>
					<div class="panel-body">
						<table class="table table-hover">
							...
							<tr>
								...
								<td><%=contato.getNome()%>
								<td><%=contato.getEmail()%>
								<td><a href="ExibeContato?id=<%=contato.getId()%>"><img
										src="imagens/userEdit32.png" height="24px" width="24px"></a></td>
								<td><a href="excluir_contato.jsp?id=<%=contato.getId()%>"><img
										src="imagens/userDelete32.png" height="24px" width="24px"></a></td>
							</tr>
